...
%As another example, a nonsynonymous variant in the cytokine regulator SH2B3 is associated with decreased risk of coronary artery disease (Z = -4.5; P = $6.4\times 10^{-6}$), decreased platelet count (Z = -10.7; P = $1.2\times 10^{-26}$),  decreased hemoglobin levels (Z = -8.9; P = $5.6\times 10^{-19}), and increased risk of rheumatoid arthritis (Z = 5.7; P = $2.9\times 10^{-6}$), among others (Supplementary Figure AAB). 
